...
const translations = {
  en: {
    ...
    'about-lead':        'I am an architect and urbanist working across scales, from objects and buildings to complex urban systems. My practice combines architectural design, urban strategy, data analysis, and resilience-driven thinking, with a focus on recovery, biodiversity, and adaptive futures. I am interested in how materiality, ecology, and visual identity shape meaningful environments. Photography is an integral part of my practice and way of seeing the space around.',
  ...
  uk: {
    ...
    'about-lead':        'Я архітектор та міський дослідник, який працює в різних масштабах, від об’єктів і будівель до складних міських систем. Моя практика поєднує архітектурне проєктування, урбаністичні стратегії, аналіз даних і підходи, орієнтовані на стійкість, із фокусом на відновлення, біорізноманіття та адаптивне майбутнє. Мене цікавить, як матеріальність, екологія та візуальна ідентичність формують змістовні середовища. Фотографія є невід’ємною частиною моєї практики та способом бачити й осмислювати простір навколо.',
...
const heroImages = [
  ...
  { src: 'assets/photography.png',  alt: 'Photography — Raw Nature' },
];
